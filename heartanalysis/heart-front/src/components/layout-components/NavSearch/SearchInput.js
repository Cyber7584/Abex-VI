	...
	return (
		<AutoComplete
			...
			filterOption={(inputValue, option) => {
				return t(option.title).toString().toLowerCase().includes(inputValue.toString().trim().toLowerCase());
			}}
		>
			<Input placeholder={"Pesquisar"} prefix={<SearchOutlined className="mr-0" />} />
		</AutoComplete>
	);
};
